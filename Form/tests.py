...
class DocumentModelTestCase(TestCase):
    def setUp(self):
        Document.objects.create(fileName='test_file', fileContent='Jack went up the hill to fetch', documentUrl='file:///C:/Users/hp/Documents/School%20pdf/Year%202%20second/shypoet/word%20press/Godwin%20Wonah/Day%201.txt')
